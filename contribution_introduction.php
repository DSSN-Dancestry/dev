    ...
    <div class="row">
        <!-- <fieldset> -->
            ...
            <div class="column" style="display:none;margin-bottom:1%"  id="contribution_type" name="contribution_type">
                ...
                <div>
                    <label>
                        ...
                        <input type="radio" id="contribute_another_artist_lineage" name="contribute_lineage" class="contribute_lineage" value="other">
                        <!-- My code ends -->
            ...
            <div class="large-12 column">
                <button class="button" type="submit" name="login_submit" id="enter">
                    <span>Begin</span>
                </button>
            </div>
            <!-- </fieldset> -->
