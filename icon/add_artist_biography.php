	...
	<div class="row" id="bio_div">
		<div class="sectionbox">
			<div style="margin: 0px; display: flex; justify-content: space-between;">
				...
				<div class="add-reference-button" style="height: 42px;" onclick="addArtistReferences()"><img src="reference_quote.png" style="height: 40px; width: 40px; cursor: pointer;"></div>
			</div>
			<fieldset>
				...
				<div style="padding:50px 60px 0px 20px" class="modal-guts">
					...
					<div id="popup_crop">
						<div class="form_crop">
							...
							<div>
								<h2 style="display:inline">Crop photo</h2>
