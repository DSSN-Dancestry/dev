...
if ($count == 1) {
    ...
    $mail->Subject = 'Dancestry Password Change Request';

    $message = "We have received your password change request. This e-mail contains the information that you need to change your password. <br/><br/>One Time Password: $user_one_time_password<br/><br/>Thank you,<br/>Dancestry Team";
    ...
    $_SESSION["email_doesn't_exist"] = "We were not able to find a profile with that address.  Please check your email address and try again, or <a href=\"login.php\">create a new account!</a>";
