...
(function($) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                if (this.settings.showSearch) {
                    search_html = '<div id="fs_search"class="fs-search"><input type="search" placeholder="Search"/></div >';
                }
                ...
                //close button event of search bar
                $('#fs_search').on('search',function(e){  
                    th.reload();
                    openDropdown(th.$wrap);
                })
    ...
    function closeDropdown($wrap) {
        ...
        if ('undefined' !== typeof $wrap) {
            ...
            $wrap.find('select').fSelect('reload');
        }
