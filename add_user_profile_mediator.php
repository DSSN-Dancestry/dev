...
if ($count==0) {
    ...
    $_SESSION["add_user_profile"] = "That email address is already associated with an account.  <a href='forgot_user_password.php'>Forgot your password?</a>";
    $location = "login.php";
}
